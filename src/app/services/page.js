...
const servic = [
  {
    ...
    imag: "/tbl.jpg",
    details:
      "حقن الفيلر هي تقنية تجميلية تُستخدم لملء الخطوط الدقيقة واستعادة مظهر شبابي للبشرة.",
    price: "1500 جنيه",
    duration: "30 دقيقة",
    steps: [
    ...
    risks: ["تورم مؤقت", "كدمات طفيفة", "حساسية نادرة تجاه المواد المستخدمة"],
    beforeAfter: {
  ...
  },
  {
    ...
    risks: ["احمرار مؤقت في الجلد", "تورم خفيف"],
    beforeAfter: {
  ...
  },
  {
    ...
    imag: "/images.jpg",
    details:
      "تقنيات الليزر لإزالة الشعر والندبات بشكل آمن وفعال للحصول على بشرة ناعمة.",
    ...
    risks: ["احمرار مؤقت", "تهيج الجلد في بعض الحالات"],
    beforeAfter: {
  ...
  },
  {
    ...
    risks: ["جفاف مؤقت للبشرة", "احمرار طفيف"],
    beforeAfter: {
  ...
  },
  {
    ...
    details:
      "علاج حب الشباب باستخدام أحدث التقنيات لإزالة البثور وتحسين نسيج البشرة.",
    ...
    risks: ["تهيج مؤقت في البشرة", "جفاف البشرة"],
    beforeAfter: {
  ...
  },
  {
    ...
    risks: ["حساسية الأسنان بعد التبييض", "احمرار اللثة"],
    beforeAfter: {
...
const Services = () => {
  ...
  return (
    <main className="container mx-auto px-4 py-12">
      <SliderPage />
      <h1 className="text-4xl font-extrabold text-center mt-6 mb-10 bg-gradient-to-r from-purple-400 to-pink-400 text-transparent bg-clip-text">
        خدماتنا التجميلية
      </h1>
      <p className="text-center text-gray-700 mb-12">
        استمتع بمجموعة واسعة من الخدمات التجميلية التي تقدمها عيادتنا بأحدث
        التقنيات.
      </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-8">
        {servic.map((service, index) => {
          ...
          return (
            <motion.div
              key={index}
              className={`service-card p-6 bg-white rounded-lg shadow-lg hover:shadow-2xl text-center cursor-pointer flex ${
            ...
            >
              ...
              <div className="w-1/2 flex flex-col justify-center">
                <h2 className="text-2xl font-semibold mb-2 bg-gradient-to-r from-purple-400 to-pink-400 text-transparent bg-clip-text">
                  {service.title}
                </h2>
