export default function ServiceCard({ title, description, imag , info, handleOpenPopup}) {
  return (
    <div 
    ...
    >
      <div className="opacity-0 group-hover:opacity-100 font-bold transition-all duration-300 ease-in-out">
        ...
        <button  onClick={() => handleOpenPopup(info)} className="bg-blue-600  text-white py-2 px-4 rounded-full hover:bg-blue-700 transition">
          اعرف المزيد
        </button>
      </div>
    </div>
