  ...
  return (
    <footer className="bg-gradient-to-r from-purple-500 to-pink-500 text-white text-center py-8 flex justify-center items-center gap-5">
      ...
      <div className="flex justify-center gap-8 mb-6">
        <a href="#" className="text-white text-2xl hover:text-gray-300 transition duration-300">
      ...
      <div className="text-sm">
        <p>الهاتف: <a href="tel:+201234567890" className="hover:underline">+20 123 456 7890</a></p>
        <p>البريد الإلكتروني: <a href="mailto:info@clinic.com" className="hover:underline">info@clinic.com</a></p>
      </div>

      {/* حقوق ملكية */}
      <div className="mt-6 text-xl">
        <p>تصميم وتطوير بواسطة <span className="font-semibold">Next step</span></p>
      </div>
